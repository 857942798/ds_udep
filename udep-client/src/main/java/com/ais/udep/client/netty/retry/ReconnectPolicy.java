package com.ais.udep.client.netty.retry;
 ...
 */
public class ReconnectPolicy implements RetryPolicy {
    ...
    public ReconnectPolicy(int baseSleepTimeMs, int maxRetries) {
        this(baseSleepTimeMs, maxRetries, DEFAULT_MAX_SLEEP_MS);
    }

    public ReconnectPolicy(int baseSleepTimeMs, int maxRetries, int maxSleepMs) {
